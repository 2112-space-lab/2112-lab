...
INSERT INTO config_schema.satellites (id, name, norad_id, type, launch_date, owner, object_type, period, inclination, apogee, perigee, rcs, altitude)
VALUES 
...
INSERT INTO config_schema.tles (id, norad_id, line1, line2, epoch)
VALUES 
...
INSERT INTO config_schema.tile_satellite_mappings (id, norad_id, tile_id, tle_id, context_id, intersection_latitude, intersection_longitude, intersected_at)
VALUES 
    (uuid_generate_v4(), '12345', (SELECT id FROM config_schema.tiles LIMIT 1), (SELECT id FROM config_schema.tles WHERE norad_id = '12345' LIMIT 1), (SELECT id FROM config_schema.contexts LIMIT 1), 37.7749, -122.4194, NOW()),
    (uuid_generate_v4(), '67890', (SELECT id FROM config_schema.tiles LIMIT 1 OFFSET 1), (SELECT id FROM config_schema.tles WHERE norad_id = '67890' LIMIT 1), (SELECT id FROM config_schema.contexts LIMIT 1 OFFSET 1), 48.8566, 2.3522, NOW());

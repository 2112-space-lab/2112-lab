...
func PropagatorRequest(ctx context.Context, scenarioState PropagatorClientScenarioState, serviceName models_service.ServiceName, requests []models_service.PropagatorSettings) error {
